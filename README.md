...
- 📊 Built interactive finance dashboards and managed complex datasets at **Tong Hua Asset Management Co., Ltd.** *(6 months)* Using React, Remix, Tailwind CSS, Supabase, and PostgreSQL
- 🌐 Developed enterprise-scale systems for **Internet Thailand Public Co., Ltd.** *(2 years)* Using React, Vue, Next.js, Nuxt.js, Node.js, and MySQL
